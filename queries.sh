...
echo "$($PSQL "SELECT name FROM teams LEFT JOIN games ON teams.team_id = games.winner_id OR teams.team_id = games.game_id WHERE round='Eighth-Final' AND year=2014 GROUP BY name")"
